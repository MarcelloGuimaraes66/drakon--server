...
std::string buildRoutingSystemPrompt(const std::vector<SkillDefinition>& skills)
{
    ...
    out
        ...
        << "Questions such as 'which cameras...', 'how many cameras...', 'which agents...', 'which jobs are running...', or 'which cameras have IPs ending in .01-.09' are read_state requests unless the user is also asking you to apply a change now.\n"
