...
std::string buildRoutingSystemPrompt(const std::vector<SkillDefinition>& skills)
{
    ...
    out
        ...
        << "If mode=operate and entity=camera and intent=update, selected_skill must be edit_camera or edit_cameras_batch depending on whether the scope is one camera or multiple cameras.\n"
