...
std::string buildRoutingSystemPrompt(const std::vector<SkillDefinition>& skills)
{
    ...
    out
        ...
        << "- user_message=\"algumas cameras tem terminacao de ip .01 ate .09, quais cameras sao essas?\" => selected_skill=\"read_state\", mode=\"read\", entity=\"state\", intent=\"read\", reply_language=\"pt\"\n"
        << "- user_message=\"me traga 3 id cards do job ala a banho 2 de ontem\" => selected_skill=\"read_state\", mode=\"read\", entity=\"state\", intent=\"read\", reply_language=\"pt\"\n"
