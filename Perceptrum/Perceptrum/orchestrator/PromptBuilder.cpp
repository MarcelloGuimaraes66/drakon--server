...
std::string buildRoutingSystemPrompt(const std::vector<SkillDefinition>& skills)
{
    ...
    out
        ...
        << "Use control_job only when the user wants you to start or stop one existing job runtime now.\n"
        ...
        << "- user_message=\"inicie o job ronda noturna\" => selected_skill=\"control_job\", mode=\"operate\", entity=\"job\", intent=\"update\", arguments.operation_type=\"control_job\", arguments.operation_phase=\"resolving_target\", arguments.runtime_action=\"start\", arguments.target_selector={\"name\":\"ronda noturna\"}, reply_language=\"pt\"\n"
        << "- user_message=\"pare o job da recepcao\" => selected_skill=\"control_job\", mode=\"operate\", entity=\"job\", intent=\"update\", arguments.operation_type=\"control_job\", arguments.operation_phase=\"resolving_target\", arguments.runtime_action=\"stop\", arguments.target_selector={\"description\":\"recepcao\"}, reply_language=\"pt\"\n"
